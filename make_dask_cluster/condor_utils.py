...
transfer_input_files    = utils.py,cachepreload.py,Hgg_envs.tar.gz
...
def make_htcondor_cluster(
    ...
    input_files = [os.path.join(BASEDIR, x) for x in ["utils.py","cachepreload.py", "Hgg_envs.tar.gz"]]
    ...
    params = {
            ...
            "job_extra":  {
                ...
                "Stream_Error": False,
                "+DESIRED_Sites":'"T2_US_UCSD"',
                "Requirements": '((HAS_SINGULARITY=?=True) && (TARGET.Machine != "sdsc-18.t2.ucsd.edu") && (TARGET.Machine != "sdsc-20.t2.ucsd.edu") && (TARGET.Machine != "cabinet-7-7-36.t2.ucsd.edu") && (TARGET.Machine != "cabinet-4-4-18.t2.ucsd.edu") && (TARGET.Machine != "cabinet-0-0-21.t2.ucsd.edu") && (TARGET.Machine != "cabinet-0-0-23.t2.ucsd.edu"))',
                },
